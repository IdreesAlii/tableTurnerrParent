    ...
    return (
        <>
            ...
            <div className="overflow-x-hidden">
                <section>
                    <div className="relative pt-24 md:pt-32 lg:pt-48">
                      <div className='relative'>

                        <div className="relative z-10 mx-auto flex max-w-7xl flex-col px-6 lg:block lg:px-12">
                            <div className="mx-auto max-w-lg text-center lg:ml-0 lg:max-w-full lg:text-left">
                                <h1 className="mt-8 max-w-2xl text-balance text-5xl font-headline md:text-6xl lg:mt-16 xl:text-7xl">Build 10x Faster with NS</h1>
                        ...
                        <div className="absolute inset-0 -z-10">
                            <div className="absolute inset-0 overflow-hidden bg-zinc-950/20 dark:bg-zinc-950/50">
                                <video
                                    ...
                                    muted
                                    playsInline
                                    className="size-full scale-150 object-cover opacity-50 dark:opacity-75"
