...
const faqs = [
  {
    question: "Website – SEO + conversion optimized",
    answer:
      "Owner.com builds a website designed to rank in Google local search, and convert visitors into direct orders.",
    meta: "OPTIMIZATIONS",
  },
  {
    question: "Online Orders – Simple, fast, upsells",
    answer:
      "A streamlined ordering experience with intelligent upselling and higher conversion rates.",
    meta: "BETTER AOV",
  },
  {
    question: "Zero-Commission Delivery – Flat fee",
    answer:
      "Rather than paying 20-30% per order on third-party marketplaces, you get a flat fee delivery model, improving your margins.",
    meta: "NO COMMISSIONS",
  },
  {
    question: "Automated Marketing – “Always on” automations",
    answer:
      "Built-in email, SMS & push campaigns, loyalty automation, capturing and using your own customer data.",
    meta: "AUTO PILOT",
  },
  {
    question: "Custom Mobile App – Home-screen presence",
    answer:
      "Your customers download your branded app — not a marketplace. Builds loyalty and repeat orders.",
    meta: "ACCESSIBILITY",
  },
  {
    question: "Loyalty Program – Return customer generation",
    answer:
      "A rewards system integrated into your app and ordering platform, encouraging repeat visits and higher lifetime value.",
    meta: "BETTER CLV",
  },
];
...
function FAQ1() {
  ...
  return (
    <div className={`relative w-full overflow-hidden transition-colors duration-700 ${palette.surface}`}>
      <section
        className={`relative z-10 mx-auto flex max-w-4xl flex-col gap-12 px-3 py-3 lg:max-w-5xl lg:px-3 ${
